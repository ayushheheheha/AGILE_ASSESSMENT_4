...
def run_tests():
    ...
    print("1. Normal Booking:", system.calculate_and_logged := system.calculate_and_book("C1", "A", "B", 10.0, 2, "Sedan", 14))
    ...
    print("8. Boundary Fare Values:", system.calculate_and_book("C8", "A", "B", 1.0, 1, "Bike", 3)) # Night + Boundary distance
    print()
